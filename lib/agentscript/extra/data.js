...
ABM.DataSet = DataSet = (function() {
  ...
  DataSet.prototype.toContext = function(gray, normalize, alpha) {
  ...
  DataSet.prototype.toDrawing = function(gray, normalize, alpha) {
    var img;
    if (gray == null) {
      gray = true;
    }
    ...
    ABM.patches.installDrawing(img = this.toImage(gray, normalize, alpha));
    return img;
  };

  DataSet.prototype.toPatchColors = function(gray, normalize, alpha) {
    var img;
    if (gray == null) {
      gray = true;
    }
    ...
    ABM.patches.installColors(img = this.toImage(gray, normalize, alpha));
    return img;
  };
