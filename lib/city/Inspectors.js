...
NeedsInspector = (function(_super) {
  ...
  NeedsInspector.under_construction = [];
  ...
  NeedsInspector.prototype._inspect_block = function(possible_block) {
    var block, blocks_in_radius, covered, dist, house, _i, _len;
  ...
  NeedsInspector.prototype._away_from_others = function(block) {
    ...
    return !(buildings_of_type.concat(NeedsInspector.under_construction)).some((function(_this) {
  ...
  NeedsInspector.prototype._notify_building_need = function(block_info) {
    ...
    return NeedsInspector.under_construction.push(block_info.block);
  };
