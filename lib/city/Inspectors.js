...
var GridRoadInspector, HouseInspector, Inspector, NodeInspector, PlotInspector, RadialRoadInspector, RoadInspector,
...
Inspector = (function() {
  ...
  Inspector.spawn_road_inspector = function(patch) {
    var inspector;
    inspector = this.spawn_inspector(patch, GridRoadInspector);
    inspector.init();
    return inspector;
  };
...
RoadInspector = (function(_super) {
  ...
  RoadInspector.prototype.s_get_inspection_point = function() {
    ...
    if (RoadInspector._valid_point(this.inspection_point)) {
  ...
  RoadInspector.prototype._is_valid_construction_point = function(patch) {
    ...
    construction_dist = RoadInspector._get_construction_dist(this.p);
...
GridRoadInspector = (function(_super) {
  ...
  GridRoadInspector.prototype.horizontal_grid_size = 6;

  GridRoadInspector.prototype.vertical_grid_size = 4;
