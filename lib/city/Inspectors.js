...
NeedsInspector = (function(_super) {
  ...
  NeedsInspector.prototype.s_get_target_plot = function() {
    ...
    plot_list = (function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        plot = _ref[_i];
        if (!(__indexOf.call(this.visited_plots, plot) >= 0)) {
          _results.push(plot);
        }
      }
      return _results;
  ...
  NeedsInspector.prototype._inspect_block = function(block) {
    var blocks_in_radius, covered, house, _i, _len;
    ...
    for (_i = 0, _len = blocks_in_radius.length; _i < _len; _i++) {
      ...
      if (House.is_house(house)) {
        if (house.dist_to_need(this.need) > this._need_threshold()) {
  ...
  NeedsInspector.prototype._valid_construction = function(block_info) {
    return this._over_threshold(info) && true;
  };

  NeedsInspector.prototype._over_threshold = function(block_info) {
    return block_info.need_covered > this._need_threshold();
  };
