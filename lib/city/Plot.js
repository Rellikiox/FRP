...
Building = (function() {
  ...
  Building.prototype._set_distances = function() {
    ...
    for (_i = 0, _len = blocks_in_radius.length; _i < _len; _i++) {
      ...
      house_dist = house.dist_to_need(this.building_type);
      if ((house_dist == null) || house_dist > m_dist) {
        _results.push(house.set_dist_to_need(this.building_type, m_dist));
      } else {
  ...
  Building.prototype._manhatan_distance_to = function(patch) {
