...
Plot = (function() {
  ...
  Plot.prototype.increase_citizens = function() {
    return this.citizens += 1;
  };
...
Block = (function() {
  ...
  Block.prototype.increase_citizens = function() {
    this.citizens += 1;
    return this.plot.increase_citizens();
  };
