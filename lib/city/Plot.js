...
Building = (function() {
  ...
  Building.default_color = [174, 131, 0];

  Building.initialize = function(buildings) {
    this.buildings = buildings;
    return this.buildings.setDefault('color', this.default_color);
  };

  Building.make_here = function(patch) {
    this.buildings.setBreed(patch);
    extend(patch, Building);
    return patch.init();
  };

  Building.is_building = function(patch) {
    return patch.breed === this.buildings;
  };
