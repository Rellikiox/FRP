...
NeedsPlanner = (function() {
  ...
  NeedsPlanner.prototype._process_hospital_need = function(house) {
    var houses_array, id, kmeans, needed_ammount, patch, people, _i, _len, _ref, _ref1, _results;
    ...
    if (needed_ammount > NeedsPlanner.supplied_needs.hospital) {
      ...
      _ref1 = this._get_patches(kmeans.centroids());
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        patch = _ref1[_i];
        _results.push(BuildingBuilder.spawn_building_builder(CityModel.instance.city_hall, patch));
      }
      return _results;
    }
  };
