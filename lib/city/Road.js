...
Road = (function() {
  ...
  Road.initialize = function(roads, config) {
    this.roads = roads;
    this.config = config;
    this.roads.setDefault("color", this.default_color);
    return Road.too_connected_threshold = config.buildings.road.road_distance;
  };
  ...
  Road.get_roads_in_n8 = function(patch) {
    var road;
    return (function() {
      var _i, _len, _ref, _results;
      _ref = patch.n;
...
RoadNode = (function() {
  ...
  RoadNode.initialize = function(road_nodes) {
    ...
    return this.road_nodes.setDefault('hidden', false);
  };
