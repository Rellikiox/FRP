...
Inspector = (function() {
  ...
  Inspector.spawn_road_inspector = function(patch) {
    var inspector;
    inspector = this.spawn_inspector(patch, RoadInspector.prototype);
    inspector.init();
    return inspector;
  };
  ...
  Inspector.spawn_node_inspector = function(patch) {
    var inspector;
    inspector = this.spawn_inspector(patch, NodeInspector.prototype);
    inspector.init();
    return inspector;
  };
...
RoadInspector = (function(_super) {
  ...
  RoadInspector.prototype.s_find_new_endpoint = function() {
    if (Road.get_connectivity(this) > 3) {
