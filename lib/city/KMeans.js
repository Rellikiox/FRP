...
KMeans = (function() {
  ...
  KMeans._prepare_points = function(points) {
    var point;
    return (function() {
      ...
      for (_i = 0, _len = points.length; _i < _len; _i++) {
        point = points[_i];
        _results.push(KMeans._copy_point(point));
      }
      return _results;
    })();
  };
  ...
  function KMeans(points, number_of_clusters) {
    this.points = KMeans._prepare_points(points);
    this.clusters = KMeans._init_clusters(this.points, number_of_clusters);
  ...
  KMeans.prototype.move_centroids = function() {
    var cluster, index, mean_position, moved, point, summed_weights, _i, _j, _len, _len1, _ref, _ref1;
    moved = false;
    _ref = this.clusters;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      cluster = _ref[_i];
      ...
      if (summed_weights === 0 || cluster.points.length === 0) {
        index = ABM.util.randomInt(this.points.length);
        mean_position = {
