...
RoadConnector = (function(_super) {
  ...
  RoadConnector.prototype._check_for_lots = function() {
    if (Road.get_road_neighbours(this.p).length >= 2) {
      return this.msg_boards.lot.post_message({
        patch: this.p
      });
    }
  };
...
HouseBuilder = (function() {
  ...
  HouseBuilder.prototype.init = function(block) {
    this.block = block;
    return this._set_initial_state('go_to_lot');
  };

  HouseBuilder.prototype.s_go_to_lot = function() {
    var closest_road_to_target;
    if (this.path == null) {
