...
var BuildingBuilder, Bulldozer, HouseBuilder, RoadBuilder, RoadConnector, RoadExtender,
...
Bulldozer = (function() {
  ...
  Bulldozer.prototype._bulldoze_patch = function() {
    ...
    if (House.is_house(this.p)) {
      ...
      CityModel.get_patches().setBreed(this.p);
    }
...
BuildingBuilder = (function() {
  ...
  BuildingBuilder.default_color = [255, 193, 0];

  BuildingBuilder.initialize = function(building_builders) {
    this.building_builders = building_builders;
    return this.building_builders.setDefault('color', this.default_color);
  };

  BuildingBuilder.spawn_building_builder = function(starting_point, patch) {
  ...
  BuildingBuilder.prototype.init = function(block) {
    this.block = block;
    if (Road.get_road_neighbours(this.p).length > 0) {
      return this._set_initial_state('go_to_plot');
    } else {
  ...
  BuildingBuilder.prototype.build = function() {
    return Building.make_here(this.p);
  };
