...
CityModel = (function(_super) {
  ...
  CityModel.prototype.step = function() {
    ...
    _ref = this.road_makers;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      road_maker = _ref[_i];
      road_maker.step();
    }
    _ref1 = this.house_makers;
    _results = [];
  ...
  CityModel.prototype.initialize_modules = function() {
    ...
    return HouseMaker.initialize_module(this.house_makers);
  };
  ...
  CityModel.prototype.set_default_params = function() {
    ...
    this.agentBreeds("road_makers house_makers road_nodes");
  ...
  CityModel.prototype.spawn_entities = function() {
    ...
    return this.spawn_house_makers(0);
  };
