...
CityModel = (function(_super) {
  ...
  CityModel.prototype.initialize_modules = function() {
    ...
    RoadBuilder.initialize_module(this.road_makers);
    HouseBuilder.initialize_module(this.house_makers);
    Inspector.initialize_module(this.inspectors, this.config.inspectors);
  ...
  CityModel.prototype.set_default_params = function() {
    ...
    this.agents.setDefault('show_ids', this.config.debug.show_ids);
    return this.agents.setDefault('show_states', this.config.debug.show_states);
  };
