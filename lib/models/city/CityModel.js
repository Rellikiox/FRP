...
CityModel = (function(_super) {
  ...
  CityModel.prototype.initialize_modules = function() {
    return Road.initialize_module(this.patches, this.roads);
  };
  ...
  CityModel.prototype.spawn_entities = function() {
    var patch, road_maker, _i, _j, _len, _len1, _ref, _ref1;
    this.city_hall = this.create_city_hall(0, 0);
    _ref = this.city_hall.p.n;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      patch = _ref[_i];
      Road.makeHere(patch);
    }
    ...
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      patch = _ref1[_j];
      Road._set_city_hall_dist(patch, 1);
    }
