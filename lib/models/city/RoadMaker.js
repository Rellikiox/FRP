...
RoadMaker = (function(_super) {
  ...
  function RoadMaker(x, y, color, size) {
    ...
    this.current_state = this.buildToPointState;
  }
  ...
  RoadMaker.prototype.go_to_point_state = function() {
    ...
    if (this.inPoint(this.path[0])) {
      ...
      if (this.path.length === 0) {
        this.path = CityModel.instance.terrainAStar.getPath(this, this.target_point);
        this.label = "buildToPointState";
        return this.current_state = this.buildToPointState;
      }
    }
  };

  RoadMaker.prototype.buildToPointState = function() {
    this.move(this.path[0]);
  ...
  RoadMaker.prototype.getTargetPoint = function() {
    var angle, point, potential_point, x, y;
    point = null;
    while (point == null) {
